...
public class GCYMRecipes {
    ...
    private static void registerMultiblockControllerRecipes(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_arc_smelter", LARGE_ARC_SMELTER.asStack(), "KDK",
                ...
                GTMachines.ARC_FURNACE[IV].asStack(), 'D', new MaterialEntry(dust, Graphite), 'K',
                new MaterialEntry(cableGtSingle, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_mixer", LARGE_MIXER.asStack(), "FCF", "RXR", "MKM",
                ...
                new MaterialEntry(TagPrefix.cableGtSingle, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_centrifuge", LARGE_CENTRIFUGE.asStack(),
                "SFS", "CXC", "MKM",
                'C', CustomTags.IV_CIRCUITS,
                'F', ChemicalHelper.get(pipeHuge, StainlessSteel),
                'S', ChemicalHelper.get(spring, MolybdenumDisilicide),
                'M', ELECTRIC_MOTOR_IV.asStack(),
                'X', CENTRIFUGE[IV].asStack(),
                'K', new MaterialEntry(TagPrefix.cableGtSingle, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "mega_blast_furnace", MEGA_BLAST_FURNACE.asStack(),
                "PCP", "FSF", "DWD",
                'C', ZPM_CIRCUITS,
                'S', GTMultiMachines.ELECTRIC_BLAST_FURNACE.asStack(),
                'F', FIELD_GENERATOR_ZPM.asStack(),
                'P', new MaterialEntry(spring, Naquadah),
                'D', new MaterialEntry(plateDense, NaquadahAlloy),
                'W', new MaterialEntry(wireGtQuadruple, RutheniumTriniumAmericiumNeutronate));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "mega_vacuum_freezer", MEGA_VACUUM_FREEZER.asStack(),
                "PCP", "FSF", "DWD",
                'C', ZPM_CIRCUITS,
                'S', GTMultiMachines.VACUUM_FREEZER.asStack(),
                'F', FIELD_GENERATOR_ZPM.asStack(),
                'P', new MaterialEntry(pipeNormal, NiobiumTitanium),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_material_press", LARGE_MATERIAL_PRESS.asStack(),
                ...
                FORGE_HAMMER[IV].asStack(), 'K', new MaterialEntry(cableGtSingle, Platinum));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_cutter", LARGE_CUTTER.asStack(),
                "SMS", "CZL", "EKE",
                'Z', CustomTags.IV_CIRCUITS,
                'L', LATHE[IV].asStack(),
                'E', ELECTRIC_MOTOR_IV.asStack(),
                'C', CUTTER[IV].asStack(),
                'M', CONVEYOR_MODULE_IV.asStack(),
                'S', new MaterialEntry(toolHeadBuzzSaw, TungstenCarbide),
                'K', new MaterialEntry(cableGtSingle, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_distillery", LARGE_DISTILLERY.asStack(),
                "PZP", "EDE", "PZP",
                'Z', CustomTags.IV_CIRCUITS,
                'D', GTMultiMachines.DISTILLATION_TOWER.asStack(),
                'E', ELECTRIC_PUMP_IV.asStack(),
                'P', ChemicalHelper.get(pipeLarge, Iridium));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_solidifier", LARGE_SOLIDIFIER.asStack(),
                "PZP", "ESE", "PKP",
                'Z', CustomTags.IV_CIRCUITS,
                'S', FLUID_SOLIDIFIER[IV].asStack(),
                'E', ELECTRIC_PUMP_IV.asStack(),
                'P', ChemicalHelper.get(pipeNormal, Polyethylene),
                'K', new MaterialEntry(cableGtSingle, Platinum));
