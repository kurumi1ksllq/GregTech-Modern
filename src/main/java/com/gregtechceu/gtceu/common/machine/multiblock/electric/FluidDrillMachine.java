    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (getRecipeLogic().getVeinFluid() != null) {
                ...
                textList.add(GTUtil.translatable("gtceu.multiblock.fluid_rig.drilled_fluid", fluidInfo)
                ...
                textList.add(GTUtil.translatable("gtceu.multiblock.fluid_rig.fluid_amount", amountInfo)
                        .withStyle(ChatFormatting.GRAY));
            } else {
                Component noFluid = GTUtil.translatable("gtceu.multiblock.fluid_rig.no_fluid_in_area")
                        .withStyle(ChatFormatting.RED);
                textList.add(GTUtil.translatable("gtceu.multiblock.fluid_rig.drilled_fluid", noFluid)
                        .withStyle(ChatFormatting.GRAY));
            }
        } else {
