...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_miner_bronze",
                ...
                'S', new UnificationEntry(TagPrefix.pipeNormal, GTMaterials.Bronze),
                'D', new UnificationEntry(TagPrefix.gem, GTMaterials.Diamond),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_miner_steel",
                ...
                'S', new UnificationEntry(TagPrefix.pipeNormal, GTMaterials.TinAlloy),
                'D', new UnificationEntry(TagPrefix.gem, GTMaterials.Diamond),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "distillation_tower",
                ...
                'B', new UnificationEntry(TagPrefix.pipeLarge, GTMaterials.StainlessSteel), 'C', CustomTags.EV_CIRCUITS,
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "multi_furnace", GTMultiMachines.MULTI_SMELTER.asStack(),
                "PPP", "ASA", "CAC",
                'P', Blocks.FURNACE,
                'A', CustomTags.HV_CIRCUITS,
                'S', GTBlocks.CASING_INVAR_HEATPROOF.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_gas_turbine",
                GTMultiMachines.LARGE_GAS_TURBINE.asStack(), "PSP", "SAS", "CSC",
                'S', new UnificationEntry(TagPrefix.gear, GTMaterials.StainlessSteel), 'P',
