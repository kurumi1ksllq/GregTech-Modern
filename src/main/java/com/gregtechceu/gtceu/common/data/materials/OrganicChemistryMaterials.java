...
public class OrganicChemistryMaterials {
    ...
    public static void register() {
        SiliconeRubber = new Material.Builder(GTCEu.id("silicone_rubber"))
                ...
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6),
                        new MaterialStack(Oxygen, 1), new MaterialStack(Silicon, 1))
                .buildAndRegister();
        ...
        Nitrobenzene = new Material.Builder(GTCEu.id("nitrobenzene"))
                ...
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 5),
                        new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))
        ...
        RawRubber = new Material.Builder(GTCEu.id("raw_rubber"))
                ...
                .componentStacks(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();
        ...
        RawStyreneButadieneRubber = new Material.Builder(GTCEu.id("raw_styrene_butadiene_rubber"))
                ...
                .componentStacks(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 26))
                .buildAndRegister()
        ...
        PolyvinylAcetate = new Material.Builder(GTCEu.id("polyvinyl_acetate"))
                ...
                .color(0xFF9955)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 6),
        ...
        ReinforcedEpoxyResin = new Material.Builder(GTCEu.id("reinforced_epoxy_resin"))
                ...
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 4),
        ...
        GlycerylTrinitrate = new Material.Builder(GTCEu.id("glyceryl_trinitrate"))
                ...
                .componentStacks(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 5),
                        new MaterialStack(Nitrogen, 3), new MaterialStack(Oxygen, 9))
                .buildAndRegister();
        ...
        Polybenzimidazole = new Material.Builder(GTCEu.id("polybenzimidazole"))
                ...
                .toolStats(
                        ToolProperty.Builder.of(1.0F, 1.0F, 1024, 1, GTToolType.SOFT_MALLET, GTToolType.PLUNGER)
                                .build())
                .componentStacks(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 12),
        ...
        Epoxy = new Material.Builder(GTCEu.id("epoxy"))
                ...
                .appendFlags(STD_METAL)
                .componentStacks(new MaterialStack(Carbon, 21), new MaterialStack(Hydrogen, 25),
                        new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 5))
                .buildAndRegister();
        ...
        Polycaprolactam = new Material.Builder(GTCEu.id("polycaprolactam"))
                ...
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 11),
        ...
        Polytetrafluoroethylene = new Material.Builder(GTCEu.id("polytetrafluoroethylene"))
                ...
                .toolStats(
                        ToolProperty.Builder.of(1.0F, 1.0F, 512, 1, GTToolType.SOFT_MALLET, GTToolType.PLUNGER).build())
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Fluorine, 4))
        ...
        Sugar = new Material.Builder(GTCEu.id("sugar"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 12),
        ...
        Methane = new Material.Builder(GTCEu.id("methane"))
                ...
                .color(0xFF0078)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 4))
                .buildAndRegister();
        ...
        Epichlorohydrin = new Material.Builder(GTCEu.id("epichlorohydrin"))
                ...
                .color(0x712400)
                .componentStacks(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 5),
                        new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 1))
                .buildAndRegister();

        Monochloramine = new Material.Builder(GTCEu.id("monochloramine"))
                .gas()
                .color(0x3F9F80)
                .componentStacks(new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 2),
                        new MaterialStack(Chlorine, 1))
                .buildAndRegister();
        ...
        Chloroform = new Material.Builder(GTCEu.id("chloroform"))
                .fluid()
                .color(0x892CA0)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 1),
        ...
        Cumene = new Material.Builder(GTCEu.id("cumene"))
                ...
                .color(0x552200)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 9), new MaterialStack(Hydrogen, 12))
                .buildAndRegister();
        ...
        Chloromethane = new Material.Builder(GTCEu.id("chloromethane"))
                ...
                .color(0xC82CA0)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 3),
                        new MaterialStack(Chlorine, 1))
                .buildAndRegister();
        ...
        AllylChloride = new Material.Builder(GTCEu.id("allyl_chloride"))
                .fluid()
                .color(0x87DEAA)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Methane, 1),
        ...
        Propane = new Material.Builder(GTCEu.id("propane"))
                ...
                .color(0xFAE250)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();

        Propene = new Material.Builder(GTCEu.id("propene"))
                .gas()
                .color(0xFFDD55)
                .componentStacks(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 6))
                .buildAndRegister();
        ...
        Butene = new Material.Builder(GTCEu.id("butene"))
                ...
                .color(0xCF5005)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();
        ...
        Butane = new Material.Builder(GTCEu.id("butane"))
                ...
                .color(0xB6371E)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 10))
                .buildAndRegister();
        ...
        DissolvedCalciumAcetate = new Material.Builder(GTCEu.id("dissolved_calcium_acetate"))
                ...
                .color(0xDCC8B4)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Carbon, 4),
                        new MaterialStack(Oxygen, 4), new MaterialStack(Hydrogen, 6), new MaterialStack(Water, 1))
                .buildAndRegister();
        ...
        Ethenone = new Material.Builder(GTCEu.id("ethenone"))
                ...
                .color(0x141446)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 2),
                        new MaterialStack(Oxygen, 1))
                .buildAndRegister();
        ...
        Tetranitromethane = new Material.Builder(GTCEu.id("tetranitromethane"))
                ...
                .color(0x0F2828)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Nitrogen, 4),
        ...
        Dimethylamine = new Material.Builder(GTCEu.id("dimethylamine"))
                ...
                .color(0x554469)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 7),
        ...
        Dimethylhydrazine = new Material.Builder(GTCEu.id("dimethylhydrazine"))
                ...
                .color(0x000055)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 8),
        ...
        DinitrogenTetroxide = new Material.Builder(GTCEu.id("dinitrogen_tetroxide"))
                .gas()
                .color(0x004184)
                .componentStacks(new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Dimethyldichlorosilane = new Material.Builder(GTCEu.id("dimethyldichlorosilane"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6),
                        new MaterialStack(Chlorine, 2), new MaterialStack(Silicon, 1))
                .buildAndRegister();
        ...
        Styrene = new Material.Builder(GTCEu.id("styrene"))
                ...
                .color(0xD2C8BE)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();
        ...
        Phenol = new Material.Builder(GTCEu.id("phenol"))
                ...
                .color(0x784421)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 6),
                        new MaterialStack(Oxygen, 1))
                .hazard(HazardProperty.HazardTrigger.INHALATION, GTMedicalConditions.CARCINOGEN)
                .buildAndRegister();
        ...
        BisphenolA = new Material.Builder(GTCEu.id("bisphenol_a"))
                ...
                .color(0xD4AA00)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 15), new MaterialStack(Hydrogen, 16),
                        new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        Toluene = new Material.Builder(GTCEu.id("toluene"))
                .liquid(new FluidBuilder().customStill())
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();
        ...
        DiphenylIsophtalate = new Material.Builder(GTCEu.id("diphenyl_isophthalate"))
                ...
                .color(0x246E57)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 14),
        ...
        PhthalicAcid = new Material.Builder(GTCEu.id("phthalic_acid"))
                ...
                .color(0xD1D1D1)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 6),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister()
        ...
        Dimethylbenzene = new Material.Builder(GTCEu.id("dimethylbenzene"))
                ...
                .color(0x669C40)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 10))
                .buildAndRegister()
        ...
        Diaminobenzidine = new Material.Builder(GTCEu.id("diaminobenzidine"))
                ...
                .color(0x337D59)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 12), new MaterialStack(Hydrogen, 14),
                        new MaterialStack(Nitrogen, 4))
                .buildAndRegister()
        ...
        Dichlorobenzidine = new Material.Builder(GTCEu.id("dichlorobenzidine"))
                ...
                .color(0xA1DEA6)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 12), new MaterialStack(Hydrogen, 10),
                        new MaterialStack(Chlorine, 2), new MaterialStack(Nitrogen, 2))
                .buildAndRegister()
        ...
        Nitrochlorobenzene = new Material.Builder(GTCEu.id("nitrochlorobenzene"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 4),
                        new MaterialStack(Chlorine, 1), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        Octane = new Material.Builder(GTCEu.id("octane"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .color(0x8A0A09)
                .componentStacks(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 18))
                .buildAndRegister();
        ...
        EthylTertButylEther = new Material.Builder(GTCEu.id("ethyl_tertbutyl_ether"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .color(0xB15C06)
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 14),
                        new MaterialStack(Oxygen, 1))
                .buildAndRegister();
        ...
        Naphthalene = new Material.Builder(GTCEu.id("naphthalene"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .color(0xF4F4D7)
                .componentStacks(new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 8))
                .buildAndRegister();
        ...
        PolyvinylButyral = new Material.Builder(GTCEu.id("polyvinyl_butyral"))
                ...
                .componentStacks(new MaterialStack(Butyraldehyde, 1), new MaterialStack(PolyvinylAcetate, 1))
                .buildAndRegister();
        ...
        PolychlorinatedBiphenyl = new Material.Builder(GTCEu.id("polychlorinated_biphenyl"))
                ...
                .color(0xCACC0E)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 12), new MaterialStack(Hydrogen, 8),
                        new MaterialStack(Chlorine, 2))
                .hazard(HazardProperty.HazardTrigger.INHALATION, GTMedicalConditions.CARCINOGEN)
                .buildAndRegister()
        ...
        AminoPhenol = new Material.Builder(GTCEu.id("aminophenol"))
                ...
                .color(0x784421)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 7),
                        new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1))
                .buildAndRegister()
        ...
        Paracetamol = new Material.Builder(GTCEu.id("paracetamol"))
                ...
                .color(0xF2EDCB)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 9),
                        new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        AmmoniumFormate = new Material.Builder(GTCEu.id("ammonium_formate"))
                .gas()
                .color(0x93badb)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 5),
                        new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))
