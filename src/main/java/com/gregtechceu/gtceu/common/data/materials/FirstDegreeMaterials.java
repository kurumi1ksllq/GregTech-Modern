...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        Almandine = new Material.Builder(GTCEu.id("almandine"))
                ...
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Iron, 3),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();

        Andradite = new Material.Builder(GTCEu.id("andradite"))
                .gem(1)
                .color(0xffce26).secondaryColor(0x647d59).iconSet(RUBY)
                .componentStacks(new MaterialStack(Calcium, 3), new MaterialStack(Iron, 2),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        AnnealedCopper = new Material.Builder(GTCEu.id("annealed_copper"))
                ...
                .componentStacks(new MaterialStack(Copper, 1))
        ...
        Asbestos = new Material.Builder(GTCEu.id("asbestos"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 3), new MaterialStack(Silicon, 2),
                        new MaterialStack(Hydrogen, 4), new MaterialStack(Oxygen, 9))
                .buildAndRegister();
        ...
        Ash = new Material.Builder(GTCEu.id("ash"))
                ...
                .componentStacks(new MaterialStack(Carbon, 1))
                .buildAndRegister();

        Hematite = new Material.Builder(GTCEu.id("hematite"))
                .dust().ore()
                .color(0xff7161).secondaryColor(0x330817)
                .componentStacks(new MaterialStack(Iron, 2), new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        BatteryAlloy = new Material.Builder(GTCEu.id("battery_alloy"))
                ...
                .componentStacks(new MaterialStack(Lead, 4), new MaterialStack(Antimony, 1))
                .buildAndRegister();
        ...
        BlueTopaz = new Material.Builder(GTCEu.id("blue_topaz"))
                ...
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Silicon, 1),
                        new MaterialStack(Fluorine, 2), new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 6))
                .buildAndRegister();
        ...
        Bone = new Material.Builder(GTCEu.id("bone"))
                ...
                .componentStacks(new MaterialStack(Calcium, 3))
                .buildAndRegister();
        ...
        Brass = new Material.Builder(GTCEu.id("brass"))
                ...
                .componentStacks(new MaterialStack(Zinc, 1), new MaterialStack(Copper, 3))
        ...
        Bronze = new Material.Builder(GTCEu.id("bronze"))
                ...
                .componentStacks(new MaterialStack(Tin, 1), new MaterialStack(Copper, 3))
        ...
        Goethite = new Material.Builder(GTCEu.id("goethite"))
                ...
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Hydrogen, 1),
        ...
        Calcite = new Material.Builder(GTCEu.id("calcite"))
                ...
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Carbon, 1),
        ...
        Cassiterite = new Material.Builder(GTCEu.id("cassiterite"))
                ...
                .componentStacks(new MaterialStack(Tin, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        Chalcopyrite = new Material.Builder(GTCEu.id("chalcopyrite"))
                ...
                .componentStacks(new MaterialStack(Copper, 1), new MaterialStack(Iron, 1), new MaterialStack(Sulfur, 2))
                .buildAndRegister();
        ...
        Chromite = new Material.Builder(GTCEu.id("chromite"))
                ...
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Chromium, 2),
        ...
        Cinnabar = new Material.Builder(GTCEu.id("cinnabar"))
                ...
                .componentStacks(new MaterialStack(Mercury, 1), new MaterialStack(Sulfur, 1))
                .buildAndRegister();
        ...
        Water = new Material.Builder(GTCEu.id("water"))
                ...
                .color(0x0000FF)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 1))
                .buildAndRegister();
        ...
        Cobaltite = new Material.Builder(GTCEu.id("cobaltite"))
                ...
                .componentStacks(new MaterialStack(Cobalt, 1), new MaterialStack(Arsenic, 1),
        ...
        Cooperite = new Material.Builder(GTCEu.id("cooperite"))
                ...
                .componentStacks(new MaterialStack(Platinum, 3), new MaterialStack(Nickel, 1),
                        new MaterialStack(Sulfur, 1), new MaterialStack(Palladium, 1))
                .buildAndRegister();
        ...
        Cupronickel = new Material.Builder(GTCEu.id("cupronickel"))
                ...
                .componentStacks(new MaterialStack(Copper, 1), new MaterialStack(Nickel, 1))
                .itemPipeProperties(2048, 1)
                .cableProperties(V[MV], 1, 1)
                .buildAndRegister();
        ...
        Electrum = new Material.Builder(GTCEu.id("electrum"))
                ...
                .componentStacks(new MaterialStack(Silver, 1), new MaterialStack(Gold, 1))
        ...
        Emerald = new Material.Builder(GTCEu.id("emerald"))
                ...
                .componentStacks(new MaterialStack(Beryllium, 3), new MaterialStack(Aluminium, 2),
                        new MaterialStack(Silicon, 6), new MaterialStack(Oxygen, 18))
                .buildAndRegister();
        ...
        Galena = new Material.Builder(GTCEu.id("galena"))
                ...
                .flags(NO_SMELTING)
                .componentStacks(new MaterialStack(Lead, 1), new MaterialStack(Sulfur, 1))
                .buildAndRegister();

        Garnierite = new Material.Builder(GTCEu.id("garnierite"))
                .dust(3).ore()
                .color(0x32c880).secondaryColor(0x344028).iconSet(METALLIC)
                .componentStacks(new MaterialStack(Nickel, 1), new MaterialStack(Oxygen, 1))
                .buildAndRegister();
        ...
        GreenSapphire = new Material.Builder(GTCEu.id("green_sapphire"))
                ...
                .appendFlags(EXT_METAL, NO_SMASHING, NO_SMELTING, HIGH_SIFTER_OUTPUT)
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Oxygen, 3))
                .buildAndRegister();

        Grossular = new Material.Builder(GTCEu.id("grossular"))
                .gem(1).ore(3, 1)
                .color(0xffb777).secondaryColor(0x856f48).iconSet(RUBY)
                .componentStacks(new MaterialStack(Calcium, 3), new MaterialStack(Aluminium, 2),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        Ilmenite = new Material.Builder(GTCEu.id("ilmenite"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Titanium, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        Rutile = new Material.Builder(GTCEu.id("rutile"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Titanium, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        Invar = new Material.Builder(GTCEu.id("invar"))
                ...
                .componentStacks(new MaterialStack(Iron, 2), new MaterialStack(Nickel, 1))
        ...
        Kanthal = new Material.Builder(GTCEu.id("kanthal"))
                ...
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Aluminium, 1),
                        new MaterialStack(Chromium, 1))
        ...
        Lazurite = new Material.Builder(GTCEu.id("lazurite"))
                ...
                .componentStacks(new MaterialStack(Aluminium, 6), new MaterialStack(Silicon, 6),
                        new MaterialStack(Calcium, 8), new MaterialStack(Sodium, 8))
                .buildAndRegister();
        ...
        Magnalium = new Material.Builder(GTCEu.id("magnalium"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Aluminium, 2))
        ...
        Magnesite = new Material.Builder(GTCEu.id("magnesite"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Carbon, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        Magnetite = new Material.Builder(GTCEu.id("magnetite"))
                ...
                .componentStacks(new MaterialStack(Iron, 3), new MaterialStack(Oxygen, 4))
                .buildAndRegister();

        Molybdenite = new Material.Builder(GTCEu.id("molybdenite"))
                .dust().ore()
                .color(0xe3ddc3).secondaryColor(0x191919).iconSet(METALLIC)
                .componentStacks(new MaterialStack(Molybdenum, 1), new MaterialStack(Sulfur, 2))
                .buildAndRegister();
        ...
        Nichrome = new Material.Builder(GTCEu.id("nichrome"))
                ...
                .appendFlags(EXT_METAL, GENERATE_SPRING)
                .componentStacks(new MaterialStack(Nickel, 4), new MaterialStack(Chromium, 1))
        ...
        NiobiumNitride = new Material.Builder(GTCEu.id("niobium_nitride"))
                ...
                .componentStacks(new MaterialStack(Niobium, 1), new MaterialStack(Nitrogen, 1))
        ...
        NiobiumTitanium = new Material.Builder(GTCEu.id("niobium_titanium"))
                ...
                .componentStacks(new MaterialStack(Niobium, 1), new MaterialStack(Titanium, 1))
        ...
        Obsidian = new Material.Builder(GTCEu.id("obsidian"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Iron, 1),
                        new MaterialStack(Silicon, 2), new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Phosphate = new Material.Builder(GTCEu.id("phosphate"))
                ...
                .componentStacks(new MaterialStack(Phosphorus, 1), new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        PlatinumRaw = new Material.Builder(GTCEu.id("platinum_raw"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Platinum, 1), new MaterialStack(Chlorine, 2))
                .buildAndRegister();
        ...
        SterlingSilver = new Material.Builder(GTCEu.id("sterling_silver"))
                ...
                .componentStacks(new MaterialStack(Copper, 1), new MaterialStack(Silver, 4))
        ...
        RoseGold = new Material.Builder(GTCEu.id("rose_gold"))
                ...
                .componentStacks(new MaterialStack(Copper, 1), new MaterialStack(Gold, 4))
        ...
        BlackBronze = new Material.Builder(GTCEu.id("black_bronze"))
                ...
                .appendFlags(EXT2_METAL, GENERATE_GEAR)
                .componentStacks(new MaterialStack(Gold, 1), new MaterialStack(Silver, 1), new MaterialStack(Copper, 3))
        ...
        BismuthBronze = new Material.Builder(GTCEu.id("bismuth_bronze"))
                ...
                .appendFlags(EXT2_METAL)
                .componentStacks(new MaterialStack(Bismuth, 1), new MaterialStack(Zinc, 1),
        ...
        Biotite = new Material.Builder(GTCEu.id("biotite"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Magnesium, 3),
                        new MaterialStack(Aluminium, 3), new MaterialStack(Fluorine, 2), new MaterialStack(Silicon, 3),
        ...
        Powellite = new Material.Builder(GTCEu.id("powellite"))
                ...
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Molybdenum, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Pyrite = new Material.Builder(GTCEu.id("pyrite"))
                ...
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Sulfur, 2))
                .buildAndRegister();

        Pyrolusite = new Material.Builder(GTCEu.id("pyrolusite"))
                .dust().ore()
                .color(0xc7b5ab).secondaryColor(0x595756)
                .componentStacks(new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();

        Pyrope = new Material.Builder(GTCEu.id("pyrope"))
                .gem().ore(3, 1)
                .color(0xe81958).secondaryColor(0x811e00).iconSet(RUBY)
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Magnesium, 3),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        RockSalt = new Material.Builder(GTCEu.id("rock_salt"))
                ...
                .flags(NO_SMASHING)
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Chlorine, 1))
                .buildAndRegister();

        RTMAlloy = new Material.Builder(GTCEu.id("rtm_alloy"))
                .ingot().fluid()
                .color(0x30306B).iconSet(SHINY)
                .componentStacks(new MaterialStack(Ruthenium, 4), new MaterialStack(Tungsten, 2),
        ...
        Ruridit = new Material.Builder(GTCEu.id("ruridit"))
                ...
                .componentStacks(new MaterialStack(Ruthenium, 2), new MaterialStack(Iridium, 1))
                .blast(b -> b.temp(4500, GasTier.HIGH)
        ...
        Ruby = new Material.Builder(GTCEu.id("ruby"))
                ...
                .componentStacks(new MaterialStack(Chromium, 1), new MaterialStack(Aluminium, 2),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        Salt = new Material.Builder(GTCEu.id("salt"))
                ...
                .flags(NO_SMASHING)
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Chlorine, 1))
                .buildAndRegister();
        ...
        Saltpeter = new Material.Builder(GTCEu.id("saltpeter"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Nitrogen, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        Scheelite = new Material.Builder(GTCEu.id("scheelite"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Tungsten, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister()
        ...
        Sodalite = new Material.Builder(GTCEu.id("sodalite"))
                ...
                .flags(GENERATE_PLATE, GENERATE_ROD, NO_SMASHING, NO_SMELTING, CRYSTALLIZABLE,
                        DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Aluminium, 3), new MaterialStack(Silicon, 3),
                        new MaterialStack(Sodium, 4), new MaterialStack(Chlorine, 1))
                .buildAndRegister();

        AluminiumSulfite = new Material.Builder(GTCEu.id("aluminium_sulfite"))
                .dust()
                .color(0xd4ecf9).secondaryColor(0xa6b9b6)
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Sulfur, 3),
        ...
        Tantalite = new Material.Builder(GTCEu.id("tantalite"))
                ...
                .componentStacks(new MaterialStack(Manganese, 1), new MaterialStack(Tantalum, 2),
        ...
        SolderingAlloy = new Material.Builder(GTCEu.id("soldering_alloy"))
                ...
                .componentStacks(new MaterialStack(Tin, 6), new MaterialStack(Lead, 3), new MaterialStack(Antimony, 1))
                .buildAndRegister();

        Spessartine = new Material.Builder(GTCEu.id("spessartine"))
                .gem().ore(3, 1)
                .color(0xffa81e).secondaryColor(0xb33700).iconSet(RUBY)
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Manganese, 3),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        Sphalerite = new Material.Builder(GTCEu.id("sphalerite"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Zinc, 1), new MaterialStack(Sulfur, 1))
                .buildAndRegister();
        ...
        StainlessSteel = new Material.Builder(GTCEu.id("stainless_steel"))
                ...
                .appendFlags(EXT2_METAL, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_FRAME, GENERATE_LONG_ROD,
                        GENERATE_FOIL, GENERATE_GEAR)
                .componentStacks(new MaterialStack(Iron, 6), new MaterialStack(Chromium, 1),
                        new MaterialStack(Manganese, 1), new MaterialStack(Nickel, 1))
        ...
        Steel = new Material.Builder(GTCEu.id("steel"))
                ...
                .appendFlags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_SPRING,
                        ...
                        GENERATE_DENSE)
                .componentStacks(new MaterialStack(Iron, 1))
        ...
        Stibnite = new Material.Builder(GTCEu.id("stibnite"))
                ...
                .componentStacks(new MaterialStack(Antimony, 2), new MaterialStack(Sulfur, 3))
                .buildAndRegister();

        Tetrahedrite = new Material.Builder(GTCEu.id("tetrahedrite"))
                .dust().ore()
                .color(0xa3a09b).secondaryColor(0x143313)
                .componentStacks(new MaterialStack(Copper, 3), new MaterialStack(Antimony, 1),
                        new MaterialStack(Sulfur, 3), new MaterialStack(Iron, 1))
                .buildAndRegister();
        ...
        TinAlloy = new Material.Builder(GTCEu.id("tin_alloy"))
                ...
                .appendFlags(EXT2_METAL)
                .componentStacks(new MaterialStack(Tin, 1), new MaterialStack(Iron, 1))
        ...
        Topaz = new Material.Builder(GTCEu.id("topaz"))
                ...
                .appendFlags(EXT_METAL, NO_SMASHING, NO_SMELTING, HIGH_SIFTER_OUTPUT)
                .componentStacks(new MaterialStack(Aluminium, 2), new MaterialStack(Silicon, 1),
                        new MaterialStack(Fluorine, 1), new MaterialStack(Hydrogen, 2))
                .buildAndRegister();
        ...
        Tungstate = new Material.Builder(GTCEu.id("tungstate"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Tungsten, 1), new MaterialStack(Lithium, 2),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister()
        ...
        Ultimet = new Material.Builder(GTCEu.id("ultimet"))
                ...
                .componentStacks(new MaterialStack(Cobalt, 5), new MaterialStack(Chromium, 2),
                        new MaterialStack(Nickel, 1), new MaterialStack(Molybdenum, 1))
        ...
        Uraninite = new Material.Builder(GTCEu.id("uraninite"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Uranium238, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister()
                .setFormula("UO2", true);
        ...
        Uvarovite = new Material.Builder(GTCEu.id("uvarovite"))
                ...
                .componentStacks(new MaterialStack(Calcium, 3), new MaterialStack(Chromium, 2),
                        new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        VanadiumGallium = new Material.Builder(GTCEu.id("vanadium_gallium"))
                ...
                .componentStacks(new MaterialStack(Vanadium, 3), new MaterialStack(Gallium, 1))
        ...
        Wulfenite = new Material.Builder(GTCEu.id("wulfenite"))
                ...
                .componentStacks(new MaterialStack(Lead, 1), new MaterialStack(Molybdenum, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        YttriumBariumCuprate = new Material.Builder(GTCEu.id("yttrium_barium_cuprate"))
                ...
                .appendFlags(EXT_METAL, GENERATE_FINE_WIRE, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FOIL,
                        GENERATE_BOLT_SCREW)
                .componentStacks(new MaterialStack(Yttrium, 1), new MaterialStack(Barium, 2),
                        new MaterialStack(Copper, 3), new MaterialStack(Oxygen, 7))
        ...
        TungsticAcid = new Material.Builder(GTCEu.id("tungstic_acid"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Hydrogen, 2), new MaterialStack(Tungsten, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Osmiridium = new Material.Builder(GTCEu.id("osmiridium"))
                ...
                .componentStacks(new MaterialStack(Iridium, 3), new MaterialStack(Osmium, 1))
        ...
        GalliumArsenide = new Material.Builder(GTCEu.id("gallium_arsenide"))
                ...
                .componentStacks(new MaterialStack(Arsenic, 1), new MaterialStack(Gallium, 1))
        ...
        Potash = new Material.Builder(GTCEu.id("potash"))
                ...
                .componentStacks(new MaterialStack(Potassium, 2), new MaterialStack(Oxygen, 1))
                .buildAndRegister();

        SodaAsh = new Material.Builder(GTCEu.id("soda_ash"))
                .dust(1)
                .color(0xffffff).secondaryColor(0xDCDCFF)
                .componentStacks(new MaterialStack(Sodium, 2), new MaterialStack(Carbon, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        IndiumGalliumPhosphide = new Material.Builder(GTCEu.id("indium_gallium_phosphide"))
                ...
                .appendFlags(STD_METAL, DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Indium, 1), new MaterialStack(Gallium, 1),
        ...
        NickelZincFerrite = new Material.Builder(GTCEu.id("nickel_zinc_ferrite"))
                ...
                .flags(GENERATE_RING)
                .componentStacks(new MaterialStack(Nickel, 1), new MaterialStack(Zinc, 1), new MaterialStack(Iron, 4),
        ...
        MagnesiumChloride = new Material.Builder(GTCEu.id("magnesium_chloride"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Chlorine, 2))
                .buildAndRegister();

        SodiumSulfide = new Material.Builder(GTCEu.id("sodium_sulfide"))
                .dust(1)
                .color(0xffd83d).secondaryColor(0xc54a00)
                .componentStacks(new MaterialStack(Sodium, 2), new MaterialStack(Sulfur, 1))
                .buildAndRegister();
        ...
        PhosphorusPentoxide = new Material.Builder(GTCEu.id("phosphorus_pentoxide"))
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Phosphorus, 4), new MaterialStack(Oxygen, 10))
                .buildAndRegister();

        Quicklime = new Material.Builder(GTCEu.id("quicklime"))
                .dust(1)
                .color(0xecfff3).secondaryColor(0x7d8e83)
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Oxygen, 1))
        ...
        SodiumBisulfate = new Material.Builder(GTCEu.id("sodium_bisulfate"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Hydrogen, 1),
                        new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Magnesia = new Material.Builder(GTCEu.id("magnesia"))
                ...
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Oxygen, 1))
                .buildAndRegister();
        ...
        Realgar = new Material.Builder(GTCEu.id("realgar"))
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Arsenic, 4), new MaterialStack(Sulfur, 4))
                .buildAndRegister();
        ...
        SodiumBicarbonate = new Material.Builder(GTCEu.id("sodium_bicarbonate"))
                ...
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Hydrogen, 1),
                        new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3))
                .buildAndRegister();

        PotassiumDichromate = new Material.Builder(GTCEu.id("potassium_dichromate"))
                .dust(1)
                .color(0xff6000).secondaryColor(0xFF0000)
                .componentStacks(new MaterialStack(Potassium, 2), new MaterialStack(Chromium, 2),
        ...
        ChromiumTrioxide = new Material.Builder(GTCEu.id("chromium_trioxide"))
                .dust(1)
                .color(0xFFE4E1)
                .componentStacks(new MaterialStack(Chromium, 1), new MaterialStack(Oxygen, 3))
        ...
        SodiumHydroxide = new Material.Builder(GTCEu.id("sodium_hydroxide"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Oxygen, 1),
        ...
        SodiumPersulfate = new Material.Builder(GTCEu.id("sodium_persulfate"))
                ...
                .componentStacks(new MaterialStack(Sodium, 2), new MaterialStack(Sulfur, 2),
                        new MaterialStack(Oxygen, 8))
                .buildAndRegister();
        ...
        Bastnasite = new Material.Builder(GTCEu.id("bastnasite"))
                ...
                .componentStacks(new MaterialStack(Cerium, 1), new MaterialStack(Carbon, 1),
                        new MaterialStack(Fluorine, 1), new MaterialStack(Oxygen, 3))
                .buildAndRegister();

        Pentlandite = new Material.Builder(GTCEu.id("pentlandite"))
                .dust().ore()
                .color(0xe3cf13).secondaryColor(0x29315b)
                .componentStacks(new MaterialStack(Nickel, 9), new MaterialStack(Sulfur, 8))
                .buildAndRegister();

        Spodumene = new Material.Builder(GTCEu.id("spodumene"))
                .dust().ore()
                .color(0xffbcbc).secondaryColor(0xc490ff)
                .componentStacks(new MaterialStack(Lithium, 1), new MaterialStack(Aluminium, 1),
                        new MaterialStack(Silicon, 2), new MaterialStack(Oxygen, 6))
                .buildAndRegister();

        Lepidolite = new Material.Builder(GTCEu.id("lepidolite"))
                .dust().ore(2, 1)
                .color(0xffdae4).secondaryColor(0x75376f).iconSet(FINE)
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Lithium, 3),
                        new MaterialStack(Aluminium, 4), new MaterialStack(Fluorine, 2), new MaterialStack(Oxygen, 10))
                .buildAndRegister();

        GlauconiteSand = new Material.Builder(GTCEu.id("glauconite_sand"))
                .dust().ore(3, 1)
                .color(0x1da351).secondaryColor(0x1a6e8f).iconSet(SAND)
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Magnesium, 2),
                        new MaterialStack(Aluminium, 4), new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 12))
                .buildAndRegister();

        Malachite = new Material.Builder(GTCEu.id("malachite"))
                .gem().ore()
                .color(0x00f1b0).secondaryColor(0x107a47).iconSet(LAPIS)
                .componentStacks(new MaterialStack(Copper, 2), new MaterialStack(Carbon, 1),
                        new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 5))
                .buildAndRegister();

        Mica = new Material.Builder(GTCEu.id("mica"))
                .dust().ore(2, 1)
                .color(0xecfeff).secondaryColor(0xc2a03c).iconSet(FINE)
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Aluminium, 3),
                        new MaterialStack(Silicon, 3), new MaterialStack(Fluorine, 2), new MaterialStack(Oxygen, 10))
                .buildAndRegister();

        Barite = new Material.Builder(GTCEu.id("barite"))
                .dust().ore()
                .color(0xe8e2d1).secondaryColor(0xf4b74b)
                .componentStacks(new MaterialStack(Barium, 1), new MaterialStack(Sulfur, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Alunite = new Material.Builder(GTCEu.id("alunite"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Aluminium, 3),
                        new MaterialStack(Silicon, 2), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 14))
                .buildAndRegister();

        Talc = new Material.Builder(GTCEu.id("talc"))
                .dust().ore(2, 1)
                .color(0xebffe9).secondaryColor(0x6fe19b).iconSet(FINE)
                .componentStacks(new MaterialStack(Magnesium, 3), new MaterialStack(Silicon, 4),
                        new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 12))
                .buildAndRegister();
        ...
        TungstenCarbide = new Material.Builder(GTCEu.id("tungsten_carbide"))
                ...
                .componentStacks(new MaterialStack(Tungsten, 1), new MaterialStack(Carbon, 1))
        ...
        CarbonDioxide = new Material.Builder(GTCEu.id("carbon_dioxide"))
                .gas()
                .color(0xA9D0F5)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 2))
                .buildAndRegister();
        ...
        TitaniumTetrachloride = new Material.Builder(GTCEu.id("titanium_tetrachloride"))
                ...
                .color(0xD40D5C)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Titanium, 1), new MaterialStack(Chlorine, 4))
                .buildAndRegister();

        NitrogenDioxide = new Material.Builder(GTCEu.id("nitrogen_dioxide"))
                .gas()
                .color(0x85FCFF)
                .componentStacks(new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))
        ...
        HydrogenSulfide = new Material.Builder(GTCEu.id("hydrogen_sulfide"))
                ...
                .componentStacks(new MaterialStack(Hydrogen, 2), new MaterialStack(Sulfur, 1))
        ...
        NitricAcid = new Material.Builder(GTCEu.id("nitric_acid"))
                ...
                .color(0xCCCC00)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Hydrogen, 1), new MaterialStack(Nitrogen, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        PhosphoricAcid = new Material.Builder(GTCEu.id("phosphoric_acid"))
                ...
                .color(0xDCDC01)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Hydrogen, 3), new MaterialStack(Phosphorus, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        SulfurTrioxide = new Material.Builder(GTCEu.id("sulfur_trioxide"))
                .gas()
                .color(0xA0A014)
                .componentStacks(new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 3))
        ...
        SulfurDioxide = new Material.Builder(GTCEu.id("sulfur_dioxide"))
                .gas()
                .color(0x0E4880)
                .componentStacks(new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 2))
                .hazard(HazardProperty.HazardTrigger.INHALATION, GTMedicalConditions.POISON, 1)
                .buildAndRegister();
        ...
        CarbonMonoxide = new Material.Builder(GTCEu.id("carbon_monoxide"))
                .gas()
                .color(0x0E4880)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 1))
        ...
        HypochlorousAcid = new Material.Builder(GTCEu.id("hypochlorous_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x6F8A91)
                .componentStacks(new MaterialStack(Hydrogen, 1), new MaterialStack(Chlorine, 1),
        ...
        Ammonia = new Material.Builder(GTCEu.id("ammonia"))
                ...
                .componentStacks(new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 3))
                .buildAndRegister();

        HydrofluoricAcid = new Material.Builder(GTCEu.id("hydrofluoric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x0088AA)
                .componentStacks(new MaterialStack(Hydrogen, 1), new MaterialStack(Fluorine, 1))
        ...
        NitricOxide = new Material.Builder(GTCEu.id("nitric_oxide"))
                .gas()
                .color(0x7DC8F0)
                .componentStacks(new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1))
                .hazard(HazardProperty.HazardTrigger.INHALATION, GTMedicalConditions.POISON, 1)
                .buildAndRegister();
        ...
        Iron3Chloride = new Material.Builder(GTCEu.id("iron_iii_chloride"))
                ...
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Chlorine, 3))
                .buildAndRegister();
        ...
        Iron2Chloride = new Material.Builder(GTCEu.id("iron_ii_chloride"))
                ...
                .color(0xe8e0be)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Iron, 1), new MaterialStack(Chlorine, 2))
                .buildAndRegister();
        ...
        UraniumHexafluoride = new Material.Builder(GTCEu.id("uranium_hexafluoride"))
                ...
                .color(0x42D126)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Uranium238, 1), new MaterialStack(Fluorine, 6))
                .buildAndRegister()
                .setFormula("UF6", true);
        ...
        EnrichedUraniumHexafluoride = new Material.Builder(GTCEu.id("enriched_uranium_hexafluoride"))
                ...
                .color(0x4BF52A)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Uranium235, 1), new MaterialStack(Fluorine, 6))
                .buildAndRegister();
        ...
        NitrousOxide = new Material.Builder(GTCEu.id("nitrous_oxide"))
                .gas()
                .color(0x7DC8FF)
                .componentStacks(new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 1))
        ...
        EnderPearl = new Material.Builder(GTCEu.id("ender_pearl"))
                ...
                .componentStacks(new MaterialStack(Beryllium, 1), new MaterialStack(Potassium, 4),
        ...
        PotassiumFeldspar = new Material.Builder(GTCEu.id("potassium_feldspar"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Aluminium, 1),
                        new MaterialStack(Silicon, 1), new MaterialStack(Oxygen, 8))
                .buildAndRegister();
        ...
        NeodymiumMagnetic = new Material.Builder(GTCEu.id("magnetic_neodymium"))
                ...
                .componentStacks(new MaterialStack(Neodymium, 1))
        ...
        SodiumPotassium = new Material.Builder(GTCEu.id("sodium_potassium"))
                ...
                .color(0x64FCB4)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Potassium, 1))
                .buildAndRegister();
        ...
        SamariumMagnetic = new Material.Builder(GTCEu.id("magnetic_samarium"))
                ...
                .componentStacks(new MaterialStack(Samarium, 1))
        ...
        ManganesePhosphide = new Material.Builder(GTCEu.id("manganese_phosphide"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Manganese, 1), new MaterialStack(Phosphorus, 1))
        ...
        MagnesiumDiboride = new Material.Builder(GTCEu.id("magnesium_diboride"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Magnesium, 1), new MaterialStack(Boron, 2))
        ...
        MercuryBariumCalciumCuprate = new Material.Builder(GTCEu.id("mercury_barium_calcium_cuprate"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Mercury, 1), new MaterialStack(Barium, 2),
                        new MaterialStack(Calcium, 2), new MaterialStack(Copper, 3), new MaterialStack(Oxygen, 8))
        ...
        UraniumTriplatinum = new Material.Builder(GTCEu.id("uranium_triplatinum"))
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Uranium238, 1), new MaterialStack(Platinum, 3))
        ...
        SamariumIronArsenicOxide = new Material.Builder(GTCEu.id("samarium_iron_arsenic_oxide"))
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
                .componentStacks(new MaterialStack(Samarium, 1), new MaterialStack(Iron, 1),
                        new MaterialStack(Arsenic, 1), new MaterialStack(Oxygen, 1))
        ...
        IndiumTinBariumTitaniumCuprate = new Material.Builder(GTCEu.id("indium_tin_barium_titanium_cuprate"))
                ...
                .componentStacks(new MaterialStack(Indium, 4), new MaterialStack(Tin, 2), new MaterialStack(Barium, 2),
                        new MaterialStack(Titanium, 1), new MaterialStack(Copper, 7), new MaterialStack(Oxygen, 14))
        ...
        UraniumRhodiumDinaquadide = new Material.Builder(GTCEu.id("uranium_rhodium_dinaquadide"))
                ...
                .componentStacks(new MaterialStack(Uranium238, 1), new MaterialStack(Rhodium, 1),
                        new MaterialStack(Naquadah, 2))
        ...
        EnrichedNaquadahTriniumEuropiumDuranide = new Material.Builder(
                ...
                .flags(DECOMPOSITION_BY_CENTRIFUGING, GENERATE_FINE_WIRE)
                .componentStacks(new MaterialStack(NaquadahEnriched, 4), new MaterialStack(Trinium, 3),
                        new MaterialStack(Europium, 2), new MaterialStack(Duranium, 1))
        ...
        RutheniumTriniumAmericiumNeutronate = new Material.Builder(GTCEu.id("ruthenium_trinium_americium_neutronate"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Ruthenium, 1), new MaterialStack(Trinium, 2),
                        new MaterialStack(Americium, 1), new MaterialStack(Neutronium, 2), new MaterialStack(Oxygen, 8))
        ...
        InertMetalMixture = new Material.Builder(GTCEu.id("inert_metal_mixture"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Rhodium, 1), new MaterialStack(Ruthenium, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        RhodiumSulfate = new Material.Builder(GTCEu.id("rhodium_sulfate"))
                ...
                .color(0xEEAA55)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Rhodium, 2), new MaterialStack(Sulfur, 3),
        ...
        RutheniumTetroxide = new Material.Builder(GTCEu.id("ruthenium_tetroxide"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Ruthenium, 1), new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        OsmiumTetroxide = new Material.Builder(GTCEu.id("osmium_tetroxide"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Osmium, 1), new MaterialStack(Oxygen, 4))
        ...
        FluoroantimonicAcid = new Material.Builder(GTCEu.id("fluoroantimonic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .componentStacks(new MaterialStack(Hydrogen, 2), new MaterialStack(Antimony, 1),
                        new MaterialStack(Fluorine, 7))
                .buildAndRegister();
        ...
        TitaniumTrifluoride = new Material.Builder(GTCEu.id("titanium_trifluoride"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Titanium, 1), new MaterialStack(Fluorine, 3))
                .buildAndRegister();

        CalciumPhosphide = new Material.Builder(GTCEu.id("calcium_phosphide"))
                .dust()
                .color(0xFFF5DE).secondaryColor(0xf6baba).iconSet(METALLIC)
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Phosphorus, 1))
                .buildAndRegister();
        ...
        IndiumPhosphide = new Material.Builder(GTCEu.id("indium_phosphide"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Indium, 1), new MaterialStack(Phosphorus, 1))
                .buildAndRegister();
        ...
        TriniumSulfide = new Material.Builder(GTCEu.id("trinium_sulfide"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Trinium, 1), new MaterialStack(Sulfur, 1))
                .buildAndRegister();
        ...
        GalliumSulfide = new Material.Builder(GTCEu.id("gallium_sulfide"))
                ...
                .componentStacks(new MaterialStack(Gallium, 1), new MaterialStack(Sulfur, 1))
                .buildAndRegister();
        ...
        AntimonyTrifluoride = new Material.Builder(GTCEu.id("antimony_trifluoride"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Antimony, 1), new MaterialStack(Fluorine, 3))
                .buildAndRegister();
        ...
        EnrichedNaquadahSulfate = new Material.Builder(GTCEu.id("enriched_naquadah_sulfate"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(NaquadahEnriched, 1), new MaterialStack(Sulfur, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        NaquadriaSulfate = new Material.Builder(GTCEu.id("naquadria_sulfate"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Naquadria, 1), new MaterialStack(Sulfur, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        Pyrochlore = new Material.Builder(GTCEu.id("pyrochlore"))
                ...
                .componentStacks(new MaterialStack(Calcium, 2), new MaterialStack(Niobium, 2),
                        new MaterialStack(Oxygen, 7))
                .buildAndRegister();
        ...
        PotassiumHydroxide = new Material.Builder(GTCEu.id("potassium_hydroxide"))
                ...
                .hazard(HazardProperty.HazardTrigger.SKIN_CONTACT, GTMedicalConditions.CHEMICAL_BURNS)
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Oxygen, 1),
                        new MaterialStack(Hydrogen, 1))
                .buildAndRegister();
        ...
        PotassiumIodide = new Material.Builder(GTCEu.id("potassium_iodide"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Iodine, 1))
                .buildAndRegister();

        PotassiumCarbonate = new Material.Builder(GTCEu.id("potassium_carbonate"))
                .dust()
                .color(0xa66c71).secondaryColor(0x802d67).iconSet(METALLIC)
                .componentStacks(new MaterialStack(Potassium, 2), new MaterialStack(Carbon, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        PotassiumFerrocyanide = new Material.Builder(GTCEu.id("potassium_ferrocyanide"))
                ...
                .componentStacks(new MaterialStack(Potassium, 4), new MaterialStack(Iron, 1),
                        new MaterialStack(Carbon, 6), new MaterialStack(Nitrogen, 6))
                .buildAndRegister()
        ...
        CalciumFerrocyanide = new Material.Builder(GTCEu.id("calcium_ferrocyanide"))
                .dust()
                .color(0xc9a842).secondaryColor(0x947110).iconSet(DULL)
                .componentStacks(new MaterialStack(Calcium, 2), new MaterialStack(Iron, 1),
                        new MaterialStack(Carbon, 6), new MaterialStack(Nitrogen, 6))
                .buildAndRegister()
        ...
        CalciumHydroxide = new Material.Builder(GTCEu.id("calcium_hydroxide"))
                ...
                .componentStacks(new MaterialStack(Calcium, 1), new MaterialStack(Oxygen, 2),
        ...
        CalciumCarbonate = new Material.Builder(GTCEu.id("calcium_carbonate"))
                ...
                .componentStacks(new MaterialStack(Calcium, 2), new MaterialStack(Carbon, 1),
                        new MaterialStack(Oxygen, 3))
                .buildAndRegister();
        ...
        PotassiumCyanide = new Material.Builder(GTCEu.id("potassium_cyanide"))
                ...
                .componentStacks(new MaterialStack(Potassium, 1), new MaterialStack(Carbon, 1),
        ...
        HydrogenCyanide = new Material.Builder(GTCEu.id("hydrogen_cyanide"))
                .gas()
                .color(0x72dbd4)
                .componentStacks(new MaterialStack(Hydrogen, 1), new MaterialStack(Carbon, 1),
                        new MaterialStack(Nitrogen, 1))
                .hazard(HazardProperty.HazardTrigger.ANY, GTMedicalConditions.CHEMICAL_BURNS, true)
                .buildAndRegister();
        ...
        FormicAcid = new Material.Builder(GTCEu.id("formic_acid"))
                .gas()
                .color(0xa6a6a6)
                .componentStacks(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 2),
                        new MaterialStack(Oxygen, 2))
        ...
        PotassiumSulfate = new Material.Builder(GTCEu.id("potassium_sulfate"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Potassium, 2), new MaterialStack(Sulfur, 1),
                        new MaterialStack(Oxygen, 4))
                .buildAndRegister();
        ...
        PrussianBlue = new Material.Builder(GTCEu.id("prussian_blue"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Iron, 7), new MaterialStack(Carbon, 18),
                        new MaterialStack(Nitrogen, 18))
                .buildAndRegister()
        ...
        Glycolonitrile = new Material.Builder(GTCEu.id("glycolonitrile"))
                ...
                .color(0x5b8c8f)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 3),
                        new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1))
                .buildAndRegister();

        AcidicBromineSolution = new Material.Builder(GTCEu.id("acidic_bromine_solution"))
                .liquid()
                .color(0xc49b52)
                .componentStacks(new MaterialStack(Chlorine, 1), new MaterialStack(Bromine, 1))
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        ConcentratedBromineSolution = new Material.Builder(GTCEu.id("concentrated_bromine_solution"))
                .liquid()
                .color(0x91481e)
                .componentStacks(new MaterialStack(Bromine, 2), new MaterialStack(Chlorine, 1))
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        HydrogenIodide = new Material.Builder(GTCEu.id("hydrogen_iodide"))
                .gas()
                .color(0x8187a6)
                .componentStacks(new MaterialStack(Hydrogen, 1), new MaterialStack(Iodine, 1))
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        DiethylenetriaminePentaacetonitrile = new Material.Builder(GTCEu.id("diethylenetriamine_pentaacetonitrile"))
                ...
                .color(0xcbbfd6)
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 14), new MaterialStack(Hydrogen, 18),
                        new MaterialStack(Nitrogen, 8))
                .buildAndRegister();
        ...
        DiethylenetriaminepentaaceticAcid = new Material.Builder(GTCEu.id("diethylenetriaminepentaacetic_acid"))
                ...
                .flags(DISABLE_DECOMPOSITION)
                .componentStacks(new MaterialStack(Carbon, 14), new MaterialStack(Hydrogen, 23),
                        new MaterialStack(Nitrogen, 3), new MaterialStack(Oxygen, 10))
                .buildAndRegister();
        ...
        SodiumNitrite = new Material.Builder(GTCEu.id("sodium_nitrite"))
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .componentStacks(new MaterialStack(Sodium, 1), new MaterialStack(Nitrogen, 1),
                        new MaterialStack(Oxygen, 2))
                .buildAndRegister();
    }
}
