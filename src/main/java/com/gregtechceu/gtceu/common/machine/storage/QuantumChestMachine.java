...
public class QuantumChestMachine extends TieredMachine implements IAutoOutputItem, IInteractedMachine, IControllable,
    ...
    public void saveCustomPersistedData(@NotNull CompoundTag tag, boolean forDrop) {
        ...
        if (!forDrop) tag.put("lockedItem", lockedItem.serializeNBT(Platform.getFrozenRegistry()));
        tag.put("stored", stored.save(Platform.getFrozenRegistry()));
    ...
    public void loadCustomPersistedData(@NotNull CompoundTag tag) {
        ...
        lockedItem.deserializeNBT(Platform.getFrozenRegistry(), tag.getCompound("lockedItem"));
        stored = ItemStack.parseOptional(Platform.getFrozenRegistry(), tag.getCompound("stored"));
    ...
    public ItemInteractionResult onUse(BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand,
        ...
        if (hit.getDirection() == getFrontFacing() && !isRemote()) {
            ...
            if (!aabb.contains(hitVector)) return ItemInteractionResult.PASS;
