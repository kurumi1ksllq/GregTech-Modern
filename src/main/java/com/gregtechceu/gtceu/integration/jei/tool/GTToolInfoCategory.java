...
public class GTToolInfoCategory extends ModularUIRecipeCategory<GTToolInfoWrapper> {
    ...
    public final static RecipeType<GTToolInfoWrapper> RECIPE_TYPE = new RecipeType<>(GTCEu.id("tool_diagram"),
            GTToolInfoWrapper.class);
    ...
    public GTToolInfoCategory(IJeiHelpers helpers) {
        ...
        this.icon = helpers.getGuiHelper()
                .createDrawableItemStack(ToolHelper.get(GTToolType.CROWBAR, GTMaterials.Iron));
    }
