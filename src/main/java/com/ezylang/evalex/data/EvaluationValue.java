...
public class EvaluationValue implements Comparable<EvaluationValue> {
    ...
    public enum DataType {
        ...
        BOOLEAN,
        /**
         * A date time value, stored as {@link Instant}.
         */
        DATE_TIME,
        /**
         * A period value, stored as {@link Duration}.
         */
        DURATION,
        /**
         * A list evaluation values. Stored as {@link List<EvaluationValue>}.
         */
        ARRAY,
        /**
         * A structure with pairs of name/value members. Name is a string and the value is a {@link
         * EvaluationValue}. Stored as a {@link Map}.
         */
        STRUCTURE,
        /**
