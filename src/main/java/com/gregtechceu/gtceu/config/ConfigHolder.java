...
public class ConfigHolder {
    ...
    public static class RecipeConfigs {
        ...
        @Configurable.Comment({
                ...
                "Default: true" })
        public boolean harderBrickRecipes = true;
        @Configurable
        ...
        @Configurable.Comment({ "Whether to make Wood related recipes harder.", "Excludes sticks and planks.",
                "Default: true" })
        public boolean hardWoodRecipes = true;
        @Configurable
        ...
        @Configurable
        @Configurable.Comment({ "Whether to make Redstone related recipes harder.", "Default: true" })
        public boolean hardRedstoneRecipes = true;
        @Configurable
        @Configurable.Comment({ "Whether to make Vanilla Tools and Armor recipes harder.",
                "Excludes Flint and Steel, and Buckets.", "Default: true" })
        public boolean hardToolArmorRecipes = true;
        @Configurable
        @Configurable.Comment({ "Whether to make miscellaneous recipes harder.", "Default: true" })
        public boolean hardMiscRecipes = true;
        @Configurable
        ...
        @Configurable
        @Configurable.Comment({ "Whether to make coloring blocks like Concrete or Glass harder.", "Default: true" })
        public boolean hardDyeRecipes = true;
        @Configurable
        ...
        @Configurable
        @Configurable.Comment({ "Whether to remove Vanilla Block Recipes from the Crafting Table.", "Default: true" })
        public boolean removeVanillaBlockRecipes = true;
        @Configurable
        ...
        @Configurable
        @Configurable.Comment({ "Whether to nerf machine controller recipes.", "Default: true" })
        public boolean hardMultiRecipes = true; // default false
        @Configurable
        @Configurable.Comment({
        ...
        public float maceratorRecyclingYield = 0.5f;
        @Configurable
        ...
        @Configurable.Comment({ "Percentage yield of arc furnace decomposition recycling outputs, 1.0 means 100%",
                "Default: 0.5" })
        @Configurable.DecimalRange(min = 0.0f, max = 1.0f)
        public float arcRecyclingYield = 0.5f;
        @Configurable
        ...
        @Configurable.Comment({ "Percentage yield of extractor decomposition recycling outputs, 1.0 means 100%",
                "Default: 0.5" })
        @Configurable.DecimalRange(min = 0.0f, max = 1.0f)
        public float extractorRecyclingYield = 0.5f;
    }
    ...
    public static class WorldGenConfigs {
        ...
        @Configurable.Comment({ "Should Sand-like ores fall?", "This includes gravel, sand, and red sand ores.",
                "Default: true" })
        public boolean sandOresFall = true;
    ...
    public static class MachineConfigs {
        ...
        @Configurable.Comment({ "Whether the machine's circuit slot need to be inserted a real circuit.",
                "Default: false" })
        public boolean ghostCircuit = false;
        @Configurable
        ...
        public int steamMultiParallelAmount = 4;
