...
public class PartAbility {
    ...
    public static final PartAbility PUMP_FLUID_HATCH = new PartAbility("pump_fluid_hatch","gtceu.part_ability.pump_input_hatch");
    public static final PartAbility STEAM = new PartAbility("steam","gtceu.part_ability.steam");
    public static final PartAbility STEAM_IMPORT_ITEMS = new PartAbility("steam_import_items","gtceu.part_ability.steam.input_items");
    public static final PartAbility STEAM_EXPORT_ITEMS = new PartAbility("steam_export_items","gtceu.part_ability.steam.export_items");
    ...
    public static final PartAbility OBJECT_HOLDER = new PartAbility("object_holder", "gtceu.part_ability.object_holder");
