...
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamAlloyFurnaceMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamCentrifugeMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamChemicalBathMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamCompressorMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamForgeHammerMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamMixerMachine;
import com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamOreWasherMachine;
...
public class GTMultiMachines {
    ...
    public static final MultiblockMachineDefinition STEAM_COMPRESSOR = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('X', blocks(CASING_BRONZE_BRICKS.get()).setMinGlobalLimited(14)
                            ...
                            .or(Predicates.abilities(PartAbility.STEAM_EXPORT_ITEMS).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.STEAM).setExactLimit(1)))
                    .setRepeatable(1, 3) // Middle aisle can repeat 1-3 times for tier 1-3
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_compressor"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_compressor")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
                            Component.translatable("gtceu.compressor")))
            .register();

    public static final MultiblockMachineDefinition STEAM_FORGE_HAMMER = REGISTRATE
            .multiblock("steam_forge_hammer", SteamForgeHammerMachine::new)
            .rotationState(RotationState.ALL)
            .appearanceBlock(CASING_BRONZE_BRICKS)
            .recipeType(GTRecipeTypes.FORGE_HAMMER_RECIPES)
            .recipeModifier(SteamParallelMultiblockMachine::recipeModifier, true)
            .addOutputLimit(ItemRecipeCapability.CAP, 1)
            .langValue("Steam Forge Hammer")
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("XXX", "XXX", "XXX")
                    .aisle("XXX", "X#X", "XXX")
                    .aisle("XXX", "XSX", "XXX")
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_forge_hammer"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_forge_hammer")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
                            Component.translatable("gtceu.forge_hammer")))
            .register();

    public static final MultiblockMachineDefinition STEAM_ALLOY_FURNACE = REGISTRATE
            .multiblock("steam_alloy_furnace", SteamAlloyFurnaceMachine::new)
            .rotationState(RotationState.ALL)
            .appearanceBlock(CASING_BRONZE_BRICKS)
            .recipeType(GTRecipeTypes.ALLOY_SMELTER_RECIPES)
            .recipeModifier(SteamParallelMultiblockMachine::recipeModifier, true)
            .addOutputLimit(ItemRecipeCapability.CAP, 1)
            .langValue("Steam Alloy Furnace")
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("XXX", "XXX", "XXX")
                    .aisle("XXX", "X#X", "XXX")
                    .aisle("XXX", "XSX", "XXX")
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_alloy_furnace"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_alloy_furnace")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
    ...
    public static final MultiblockMachineDefinition STEAM_MIXER = REGISTRATE
            .multiblock("steam_mixer", SteamMixerMachine::new)
            .rotationState(RotationState.ALL)
            .appearanceBlock(CASING_BRONZE_BRICKS)
            .recipeType(GTRecipeTypes.MIXER_RECIPES)
            .recipeModifier(SteamParallelMultiblockMachine::recipeModifier, true)
            .addOutputLimit(ItemRecipeCapability.CAP, 1)
            .langValue("Steam Mixer")
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("XXX", "XXX", "XXX")
                    .aisle("XXX", "X#X", "XXX")
                    .aisle("XXX", "XSX", "XXX")
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_mixer"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_mixer")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
    ...
    public static final MultiblockMachineDefinition STEAM_CENTRIFUGE = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_centrifuge"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_centrifuge")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
                            Component.translatable("gtceu.centrifuge")))
            .register();

    public static final MultiblockMachineDefinition STEAM_CHEMICAL_BATH = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_chemical_bath"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_chemical_bath")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
    ...
    public static final MultiblockMachineDefinition STEAM_ORE_WASHER = REGISTRATE
            .multiblock("steam_ore_washer", SteamOreWasherMachine::new)
            .rotationState(RotationState.ALL)
            .appearanceBlock(CASING_BRONZE_BRICKS)
            .recipeType(GTRecipeTypes.ORE_WASHER_RECIPES)
            .recipeModifier(SteamParallelMultiblockMachine::recipeModifier, true)
            .addOutputLimit(ItemRecipeCapability.CAP, 1)
            .langValue("Steam Ore Washer")
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("XXX", "XXX", "XXX")
                    .aisle("XXX", "X#X", "XXX")
                    .aisle("XXX", "XSX", "XXX")
                    ...
                    .build())
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    GTCEu.id("block/multiblock/steam_ore_washer"))
            .tooltips(
                    Component.translatable("gtceu.machine.steam_multiblock.created_by",
                            Component.translatable("gtceu.steam_ore_washer")),
                    Component.translatable("gtceu.machine.steam_multiblock.default_parallel", 4),
                    Component.translatable("gtceu.machine.steam_multiblock.recipe_type",
