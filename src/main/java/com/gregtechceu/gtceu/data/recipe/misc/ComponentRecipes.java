...
public class ComponentRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        for (Map.Entry<String, Material> materialEntry : rubberMaterials.entrySet()) {
            ...
            // Start---------------------------------------------------------------------------------------------------
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber),
                    String.format("electric_pump_lv_%s", name), ELECTRIC_PUMP_LV.asStack(),
                    "SXR", "dPw", "RMC",
                    'S', new MaterialEntry(screw, Tin),
                    'X', new MaterialEntry(rotor, Tin),
                    'P', new MaterialEntry(pipeNormal, Bronze),
                    'R', new MaterialEntry(ring, material),
                    'C', new MaterialEntry(cableGtSingle, Tin),
                    'M', ELECTRIC_MOTOR_LV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber),
                    String.format("electric_pump_mv_%s", name), ELECTRIC_PUMP_MV.asStack(),
                    "SXR", "dPw", "RMC",
                    'S', new MaterialEntry(screw, Bronze),
                    'X', new MaterialEntry(rotor, Bronze),
                    'P', new MaterialEntry(pipeNormal, Steel),
                    'R', new MaterialEntry(ring, material),
                    'C', new MaterialEntry(cableGtSingle, Copper),
                    'M', ELECTRIC_MOTOR_MV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber),
                    String.format("electric_pump_hv_%s", name), ELECTRIC_PUMP_HV.asStack(),
                    "SXR", "dPw", "RMC",
                    'S', new MaterialEntry(screw, Steel),
                    'X', new MaterialEntry(rotor, Steel),
                    'P', new MaterialEntry(pipeNormal, StainlessSteel),
                    'R', new MaterialEntry(ring, material),
                    'C', new MaterialEntry(cableGtSingle, Gold),
                    'M', ELECTRIC_MOTOR_HV.asStack());
            VanillaRecipeHelper.addShapedRecipe(provider, material.equals(Rubber),
                    String.format("electric_pump_ev_%s", name), ELECTRIC_PUMP_EV.asStack(),
                    "SXR", "dPw", "RMC",
                    'S', new MaterialEntry(screw, StainlessSteel),
                    'X', new MaterialEntry(rotor, StainlessSteel),
                    'P', new MaterialEntry(pipeNormal, Titanium),
                    'R', new MaterialEntry(ring, material),
                    'C', new MaterialEntry(cableGtSingle, Aluminium),
                    'M', ELECTRIC_MOTOR_EV.asStack());
            if (!material.equals(Rubber))
                VanillaRecipeHelper.addShapedRecipe(provider, material.equals(SiliconeRubber),
                        String.format("electric_pump_iv_%s", name), ELECTRIC_PUMP_IV.asStack(),
                        "SXR", "dPw", "RMC",
                        'S', new MaterialEntry(screw, TungstenSteel),
                        'X', new MaterialEntry(rotor, TungstenSteel),
                        'P', new MaterialEntry(pipeNormal, TungstenSteel),
                        'R', new MaterialEntry(ring, material),
                        'C', new MaterialEntry(cableGtSingle, Tungsten),
                        'M', ELECTRIC_MOTOR_IV.asStack());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, false, "cover_item_voiding", COVER_ITEM_VOIDING.asStack(),
                "SDS", "dPw", " E ",
                'S', new MaterialEntry(screw, Steel),
                'D', COVER_ITEM_DETECTOR.asStack(),
                'P', new MaterialEntry(pipeNormal, Brass),
                'E', Items.ENDER_PEARL);

        ASSEMBLER_RECIPES.recipeBuilder("cover_item_voiding")
                .inputItems(screw, Steel, 2)
                .inputItems(COVER_ITEM_DETECTOR)
                .inputItems(pipeNormal, Brass)
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, false, "cover_fluid_voiding", COVER_FLUID_VOIDING.asStack(),
                "SDS", "dPw", " E ",
                'S', new MaterialEntry(screw, Steel),
                'D', COVER_FLUID_DETECTOR.asStack(),
                'P', new MaterialEntry(pipeNormal, Bronze),
                'E', Items.ENDER_PEARL);
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "sensor_mv", SENSOR_MV.asStack(), "P G", "PR ", "XPP", 'P',
                ...
                new MaterialEntry(gemFlawless, Emerald), 'X', CustomTags.MV_CIRCUITS);
