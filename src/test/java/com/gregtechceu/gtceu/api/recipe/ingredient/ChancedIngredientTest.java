...
public class ChancedIngredientTest {
    ...
    public static void prepare(ServerLevel level) {
        ...
        CR_RECIPE_TYPE.getLookup().addRecipe(CR_RECIPE_TYPE
                ...
                .chancedInput(new FluidStack(CR_IN, 40), 5000, 0)
                .inputItems(COBBLE)
        ...
        CR_RECIPE_TYPE.getLookup().addRecipe(CR_RECIPE_TYPE
                ...
                .inputFluids(CR_OUT)
                .chancedOutput(new FluidStack(REDSTONE, 40), 5000, 0)
                .EUt(GTValues.V[GTValues.HV])
                .duration(2)
                .buildRawRecipe());
        ...
        LCR_RECIPE_TYPE.getLookup().addRecipe(LCR_RECIPE_TYPE
                ...
                .chancedInput(new FluidStack(LCR_IN, 40), 5000, 0)
                .inputFluids(RUBBER)
                .outputFluids(REDSTONE)
                .EUt(GTValues.V[GTValues.HV])
                .duration(2)
        ...
        CENTRIFUGE_RECIPE_TYPE.getLookup().addRecipe(CENTRIFUGE_RECIPE_TYPE
                ...
                .chancedInput(new FluidStack(LCENT_IN, 40), 5000, 0)
                .inputItems(COBBLE)
                .outputFluids(REDSTONE)
    ...
    @GameTest(template = "empty", batch = "ChancedIngredients")
    ...
    public static void singleblockChancedFluidInputFailure(GameTestHelper helper) {
    ...
    @GameTest(template = "singleblock_charged_cr", batch = "ChancedIngredients")
    public static void singleblockChancedFluidInput(GameTestHelper helper) {
        SimpleTieredMachine machine = (SimpleTieredMachine) getMetaMachine(
                helper.getBlockEntity(new BlockPos(0, 1, 0)));
    ...
    // Test for singleblock machine with ranged fluid input
    @GameTest(template = "singleblock_charged_cr", batch = "ChancedIngredients")
    public static void singleblockChancedFluidOutput(GameTestHelper helper) {
        SimpleTieredMachine machine = (SimpleTieredMachine) getMetaMachine(
                helper.getBlockEntity(new BlockPos(0, 1, 0)));
    ...
    @GameTest(template = "lcr_ranged_ingredients",
            batch = "ChancedIngredients")
    public static void multiblockLCRChancedFluidInput(GameTestHelper helper) {
    ...
    @GameTest(template = "lcr_ranged_ingredients",
            batch = "ChancedIngredients")
    public static void multiblockLCRChancedFluidOutput(GameTestHelper helper) {
        BusHolder busHolder = getBussesAndFormLCR(helper);
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 200)
    public static void multiblockLCentChancedFluidInput16Parallel(GameTestHelper helper) {
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 200)
    public static void multiblockLCentChancedFluidOutput16Parallel(GameTestHelper helper) {
        BusHolderBatchParallel busHolder = getBussesAndFormLCENT(helper);
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 200)
    public static void multiblockLCentChancedFluidInputBatched(GameTestHelper helper) {
        BusHolderBatchParallel busHolder = getBussesAndFormLCENT(helper);
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 200)
    public static void multiblockLCentChancedFluidOutputBatched(GameTestHelper helper) {
        BusHolderBatchParallel busHolder = getBussesAndFormLCENT(helper);
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 500)
    public static void multiblockLCentChancedFluidInput16ParallelBatched(GameTestHelper helper) {
        BusHolderBatchParallel busHolder = getBussesAndFormLCENT(helper);
    ...
    @GameTest(template = "large_centrifuge_zpm_batch_parallel16",
            batch = "ChancedIngredients",
            timeoutTicks = 500)
    public static void multiblockLCentChancedFluidOutput16ParallelBatched(GameTestHelper helper) {
        BusHolderBatchParallel busHolder = getBussesAndFormLCENT(helper);
