...
public class GTCraftingComponents {
    ...
    public static void init() {
        ...
        SAWBLADE = CraftingComponent.of("sawblade", plate, Steel)
                .add(ULV, plate, Steel)
                .add(LV, plate, Steel)
                .add(MV, plate, Aluminium)
                .add(HV, plate, StainlessSteel)
                .add(EV, plate, Titanium)
                .add(IV, plate, TungstenCarbide)
                .add(LuV, plate, TungstenCarbide)
                .add(ZPM, plate, TungstenCarbide)
                .add(UV, plate, TungstenCarbide)
                .add(UHV, plate, TungstenCarbide);
