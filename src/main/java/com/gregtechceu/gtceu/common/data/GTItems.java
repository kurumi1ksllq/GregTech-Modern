...
public class GTItems {
    ...
    public static ItemEntry<ComponentItem> FLUID_CELL_LARGE_ALUMINIUM = createFluidCell(GTMaterials.Aluminium, 32, 4, 64);
    public static ItemEntry<ComponentItem> FLUID_CELL_LARGE_STAINLESS_STEEL = createFluidCell(GTMaterials.StainlessSteel, 64, 6, 64);
    public static ItemEntry<ComponentItem> FLUID_CELL_LARGE_TITANIUM = createFluidCell(GTMaterials.Titanium, 128, 6, 64);
    public static ItemEntry<ComponentItem> FLUID_CELL_LARGE_TUNGSTEN_STEEL = createFluidCell(GTMaterials.TungstenSteel, 512, 8, 32);
    ...
    public static ItemEntry<Item> LASER_REFLECTOR = REGISTRATE.item("dielectric_laser_mirror", Item::new).register();
