...
public class CraftingRecipeLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "filter_casing_sterile",
                GTBlocks.FILTER_CASING_STERILE.asStack(), "BEB", "ISI", "MFR",
                'B', new MaterialEntry(pipeLarge, Polybenzimidazole),
                'E', EMITTER_ZPM.asStack(),
                'I', ITEM_FILTER.asStack(),
                'S', BLACKLIGHT.asStack(),
                'M', ELECTRIC_MOTOR_ZPM.asStack(),
                'F', new MaterialEntry(frameGt, Tritanium),
                'R', new MaterialEntry(rotor, NaquadahAlloy));
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "fluid_jetpack", GTItems.LIQUID_FUEL_JETPACK.asStack(),
                "xCw", "SUS", "RIR",
                'C', CustomTags.LV_CIRCUITS,
                'S', GTItems.FLUID_CELL_LARGE_STEEL.asStack(),
                'U', GTItems.ELECTRIC_PUMP_LV.asStack(),
                'R', new MaterialEntry(rotor, Lead),
                'I', new MaterialEntry(pipeSmall, Potin));
