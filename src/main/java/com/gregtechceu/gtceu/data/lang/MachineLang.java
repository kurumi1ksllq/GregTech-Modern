...
public class MachineLang {
    ...
    protected static void init(RegistrateLangProvider provider) {
        ...
        provider.add("gtceu.multiblock.steam.struct_tier", "Structure Tier: %s");
        ...
        provider.add("gtceu.machine.steam_compressor.tip", "§eMax Parallel: §f4 §7(upgradeable via structure tier)");
        provider.add("gtceu.machine.steam_forge_hammer.tip", "§eMax Parallel: §f4 §7(upgradeable via structure tier)");
        provider.add("gtceu.machine.steam_alloy_furnace.tip", "§eMax Parallel: §f4 §7(upgradeable via structure tier)");
